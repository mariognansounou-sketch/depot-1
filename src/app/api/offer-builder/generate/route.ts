...
import { BuildOfferUseCase } from "@/modules/offer-builder/use-cases/build-offer.use-case";
...
export async function POST(request: Request) {
  ...
  try {
    const useCase = new BuildOfferUseCase(getAIProvider());
    ...
    logger.error("Offer builder failed", { error: String(error) });
