...
import { FindAudienceUseCase } from "@/modules/audience-finder/use-cases/find-audience.use-case";
...
export async function POST(request: Request) {
  ...
  try {
    const useCase = new FindAudienceUseCase(getAIProvider());
    ...
    logger.error("Audience finder failed", { error: String(error) });
